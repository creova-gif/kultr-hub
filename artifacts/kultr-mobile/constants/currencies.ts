    ...
    paymentMethods: [
      {
        ...
        sub: "Bank transfer via Interac",
        icon: "credit-card",
        type: "bank",
        color: "#FFB300",
      },
      {
        id: "applepay_googlepay_ca",
